...
st.markdown(
    ...
    div[data-testid="stChatMessage"]:nth-child(odd) div[data-testid="stChatMessageContent"] {
        ...
        border: 1px solid rgba(0, 0, 0, 0.04) !important;
        box-shadow: 0 6px 16px rgba(0, 0, 0, 0.06) !important;
        animation: smoothCloudPop 0.5s ease-out forwards !important; /* Sped up to match dynamic typing better */
    }
...
if "messages" not in st.session_state:
    st.session_state.messages = [
        {
            "role": "assistant",
            "content": "Yo! What's up? Finally tame amne yaad karya! Aur bata, what's cooking today? 🤔",
        }
    ]
...
st.markdown(
    ...
    <div class="lounge-header">
        ...
        <div class="lounge-subtitle">Your Hinglish & Gujarati bestie • Available 24/7</div>
...
if user_query := st.chat_input("Say something to Gaurav..."):
    # Render user query instantly with no backend delay blocks ahead of it
    ...
    with st.chat_message("assistant", avatar=BOT_AVATAR):
        ...
        # System Instructions updated to make him a funny, enthusiastic guy who adds Gujarati flavor
        system_instruction = (
            ...
            "You naturally speak a mix of Hindi and English (Hinglish), but because you are Gujarati, "
            "you frequently drop funny, enthusiastic Gujarati expressions or blend Gujarati phrases "
            "into your sentences (e.g., 'Su vaat che!', 'Kem cho tussi?', 'Majama', 'Bhai tame toh heavy driver cho!', 'Locho thai gayo'). "
            "Use casual terms like 'Bhai', 'Yaar', 'Bro', 'Chill mar', 'tension mat le'. "
        ...
        # Note: If 1.5 seconds is too slow for your preferred chat pacing, adjust the calculation below.
        words_per_minute = 40
        word_delay = 60.0 / words_per_minute 
        
        word_list = bot_response.split()
        for word in word_list:
          full_response += word + " "message_placeholder.markdown(full_response.strip())
